...
library(viridis)  # pour les couleurs adaptées aux daltoniens
```
...
Ce premier modèle est contenue dans fit_alpha. Il va nous servir par la suite de prior informatif afin de permettre d'accélérer le temps de prédiction du modèle.
