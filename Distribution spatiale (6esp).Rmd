...
---
Ce document fait suite à **Distribution diamétrique (INRAE)** dans lequel nous avons pu identifier 6 espèces avec des structures diamétriques remarquables. Pour rappel nous utilisons les données de ALT (9ha sur P16).
L'objectif de ce script est de réaliser une carte des distributions diamétriques de : 
